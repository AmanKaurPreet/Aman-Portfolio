            ...
            <div className="about__container container grid">
                <div className="about__data">
                    ...
                    <p className="about__description">
                        Welcome to my portfolio! I'm Amanpreet kaur, a seasoned full-stack developer skilled in building scalable web applications. With expertise in front-end frameworks like React and Vue.js, coupled with robust back-end proficiency in Node.js, Python (Django), and PHP, I excel in delivering end-to-end solutions that prioritize performance and user experience.
                    </p>
                ...
                <div className="about__image"
                    ...
                    <svg
                        ...
                        <mask id="maskBorder" mask-type="alpha">
                            <path
                                d="M263 48.1782C270.426 43.891 279.574 43.891 287 48.1782L501.157 171.822C508.583 176.109 513.157 184.032 513.157 192.606V439.894C513.157 448.468 508.583 456.391 501.157 460.678L287 584.322C279.574 588.609 270.426 588.609 263 584.322L48.843 460.678C41.4174 456.391 36.843 448.468 36.843 439.894V192.606C36.843 184.032 41.4174 176.109 48.843 171.822L263 48.1782Z"
                                fill="black"
                            />
                        </mask>
                        ...
                        <defs>
                            ...
                            {/* Insert your profile image (recommended size: 640 x 940) */}
                            <image
                                style={{ zIndex: 2 }}
